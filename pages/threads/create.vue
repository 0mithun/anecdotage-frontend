          ...
          <div class="card-body">
              <form class="" action="" method="post" enctype="multipart/form-data" @submit.prevent="addNewThread">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12">
                          <div class="form-group" :class="{'is-invalid': form.errors.errors.body }">
    ...
    export default {
        ...
        methods:{
           ...
           searchTag(search, loading){
                loading(true)
                this.$axios.$get(`tag/search?q=${search}`)
                  .then(res=>{
                    this.alltags = res
                    loading(false)
                  })
            ...
            searchChannel (query, done) {
              this.$axios.$get(`channel/search?name=${query}`)
                .then(res => {
                  done(res)
                })
                .catch(err => {
...
<style lang="scss" scoped>
    ...
    .uiv .dropdown-menu>.active>a, .uiv .dropdown-menu>.active>a:focus, .uiv .dropdown-menu>.active>a:hover {
      color: #fff;
